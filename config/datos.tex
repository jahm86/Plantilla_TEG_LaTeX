...
% --- CONTROL DE MODO DE DOCUMENTO (ATEG vs TEG) ---
% DESCOMENTAR la siguiente línea para activar el modo TRABAJO ESPECIAL DE GRADO (TEG).
% Si está comentada, el documento se compila en modo ANTEPROYECTO (ATEG).
% Si está comentado (Modo ATEG): no incluye Contraportada, Aprobación, Capítulos 4+, Anexos, etc.
%\newcommand{\modoTEG}{}
